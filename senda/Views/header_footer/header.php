                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav navbar-nav topmenu-contact pull-left">
                                    <li><i class="fa fa-phone"></i> <span>Hotline:0329 33 45 42</span></li>
                                </ul>
            ...
            <div class="row">
                ...
                <div class="pull-right mobile-menu-icon-wrapper">
                    ...
                    <div class="logo logo-mobile">
                        <a href="/" title="">
                            <img src="public/image/icon/<?=$data_logo['image']?>"style="width: <?=$data_logo['width']?>;height: <?=$data_logo['height']?>" alt="">
                        </a>
                    </div>
                    <!-- End Logo mobile -->
                    <!-- Cart mobile -->
